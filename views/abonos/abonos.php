<!-- Cabecera -->
<link rel="stylesheet" href="/views/abonos/sidebar.css">

<link rel="stylesheet" href="/views/abonos/abonos.css">

<link rel="stylesheet" href="/views/abonos/table.css">
    ...
    <ul>
        ...
        <li>
            <div class="sidebar-item-active">
                ...
                <a href="/abonos/1" style="color:white;">
                    Abonos
                </a>
            </div>
        </li>
...
<header>
    <div class="header-container">
        <div class="header-izquierda">
            <h1>Abonos</h1>
            <h5 class="subtitle">Listado del historial de abonos</h5>
        </div>
