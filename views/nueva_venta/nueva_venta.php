            ...
            <div>
                ...
                <div style="display:flex;justify-content: space-between;">
                    ...
                    <div style="padding-right:20px;">
                        <button class="button-naranja" type="button" onclick="enviarFormulario('contado')"">Contado</button>
                        <button class=" button-azul" id="ACredito" type="button" onclick="mostrarDiasCredito()"> A Crédito</button>
                    </div>
                    ...
                    <div id="diasCreditoContainer" style="display:none;">
                        ...
                        <select name="dias_credito" id="diasCredito">
                            <option name="dias_credito" value="5">5 días</option>
                            <option name="dias_credito" value="15">15 días</option>
                            <option name="dias_credito" value="30">30 días</option>
                            <option name="dias_credito" value="60">60 días</option>
                        </select>
                        <button type="button" onclick="enviarFormulario('credito')" class="button">Vender a Crédito</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function buscarCliente() {
        ...
        xhr.onload = function() {
            if (xhr.status === 200) {
                if (buscarPorId) {
                    input = document.getElementById('cliente_nombre').value = xhr.responseText;
                    input.type = 'number';
                    input.id = 'cliente_nombre'
                    input.name = 'cliente_nombre'; // Aquí asignamos el nombre
                } else {
                    document.getElementById('id_cliente').value = xhr.responseText;
                }
            }
        };

        // Crea una cadena de consulta con el valor del id_cliente
        var data = 'id_cliente=' + id_cliente + '&nombre_cliente=' + cliente_nombre;
    ...
    function mostrarDiasCredito() {
        // Mostrar el contenedor de días de crédito cuando se selecciona crédito
        var buttonACredito = document.getElementById("ACredito")
        var diasCreditoContainer = document.getElementById("diasCreditoContainer");
        diasCreditoContainer.style.display = "block";
        buttonACredito.style.display = "none";
    }
</script>
